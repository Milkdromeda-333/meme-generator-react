export default function Meme(props) {
    ...
    return (
        <div id="meme--container" className="position-relative text-center text-uppercase font-weight-bold display-5 text-white">
            ...
            {props.isBookmarked === false && <span className="bi bi-bookmark-heart bookmark-icon" onClick={props.saveMemeFunc}></span> || <i className="bi bi-bookmark-heart-fill" onClick={props.saveMemeFunc}></i>}
        </div>
    );
}